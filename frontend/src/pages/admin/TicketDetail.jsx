...
const TYPE_LABELS = {
  ...
  "3p_issue_flowhcm": "FlowHCM Issue", "3p_issue_payroll": "Payroll",
  "3p_issue_hold": "Hold Payroll/Incentive", "3p_issue_release": "Release Payroll/Incentive",
  "3p_issue_fnf": "FNF Settlement", "3p_issue_optimization": "Optimization",
  "3p_issue_offboarding": "Offboarding", "3p_issue_incentive": "Incentive/Allowance",
  "3p_issue_it_assets": "IT Assets/SIM Request", "3p_issue_insurance": "Health & Life Insurance",
  "3p_issue_other": "Other (Issue Resolution)",
...
const FIELD_LABELS = {
  ...
  request_type: "Request Type", access_type: "Access Type", commando_role: "Commando Role", superset_role: "Burraq Access Module (Role)", google_request_type: "Google Workspace Request", platform_client: "Platform Client", platform_role: "Platform Role / Scope", scope_action: "Action",
  hiring_type: "Hiring Type", issue_type: "Issue Type", disciplinary_type: "Disciplinary Issue Type",
  ...
  hold_type: "Hold Type", hold_month: "Month to Hold", release_type: "Release Type",
  release_month: "Month to Release", payroll_month: "Payroll Month",
  asset_type: "Asset / SIM Required", insurance_type: "Insurance Type",
  incentive_type: "Incentive / Allowance Type", reason: "Reason",
